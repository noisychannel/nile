...
TUNE_SENTS=jsalt/data/medium/dev2.cs
...
if [ $EXP -gt 8 ]; then
  ...
  TUNE_SENTS=jsalt/data/full/dev2.cs
...
CONTEXT_FLAG="--context $TUNE_SENTS $SOURCE_EMB $TARGET_EMB $DEV_SENTS"

#./bin/train $1 $2 -h 50 --adadelta $CONTEXT_FLAG > model
